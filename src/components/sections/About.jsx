        ...
        <div className="max-w-3xl mx-auto px-4">
          <div className="text-center mb-12 cursor-hover">
            <h2 className="relative text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-500 via-cyan-400 to-purple-500 bg-clip-text text-transparent hover:from-cyan-400 hover:via-blue-500 hover:to-pink-500 transition-all duration-500 hover:scale-105 transform">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-cyan-400/20 to-purple-500/20 blur-xl opacity-0 opacity-100 transition-opacity duration-500 -z-10"></div>
            </h2>
          ...
          <div className="main-card cursor-card rounded-xl p-8 border-white/10 border hover:-translate-y-2 transition-all duration-300 hover:border-cyan-400/40 hover:shadow-xl hover:shadow-cyan-500/20 hover:bg-gradient-to-br hover:from-cyan-500/5 hover:to-blue-500/5 hover:backdrop-blur-sm">
            ...
            <div className="text-center mb-8">
              <h3 className="relative text-2xl md:text-3xl font-bold mb-3 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-400 bg-clip-text text-transparent hover:from-blue-400 hover:via-cyan-500 hover:to-pink-400 transition-all duration-500 hover:scale-105 transform cursor-hover">
                ...
                {/* Subtle glow effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/10 via-blue-500/10 to-purple-400/10 blur-lg opacity-0 hover:opacity-100 transition-opacity duration-500 -z-10"></div>
              </h3>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 text-sm hover:text-gray-200 transition-colors">
                        Comprehensive study in algorithms, data structures, and
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 text-sm hover:text-gray-200 transition-colors">
                        ...
                        applications. Led team of 3 developers in implementing
                        scalable solutions.
                      </p>
                    </div>
                  </div>
                ...
                <div className="group">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-400 mb-2">(2019)</p>
                      <p className="text-gray-300 text-sm hover:text-gray-200 transition-colors">
                        Assisted in building front-end components and
                        integration with REST APIs. Gained hands-on experience
